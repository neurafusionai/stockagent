...
TOTAL_SESSION = 3 # Number of Trades Per Day

# Initial Stock Price
STOCK_A_INITIAL_PRICE = 30
STOCK_B_INITIAL_PRICE = 40
# STOCK_B_PUBLISH = 100 # Number of Shares Issued for Stock B

# Agent Initial Assets
MAX_INITIAL_PROPERTY = 5000000.0
MIN_INITIAL_PROPERTY = 100000.0

# Loans
LOAN_TYPE = ["one-month", "two-month", "three-month"]
LOAN_TYPE_DATE = [22, 44, 66] # Loan Term

LOAN_RATE = [0.027, 0.03, 0.033] # Loan Interest Rate

REPAYMENT_DAYS = [22, 44, 66, 88, 110, 132, 154, 176, 198, 220, 242, 264] # Interest Payment Date

# Financial Report

SEASONAL_DAYS = 66 # First Quarter Time

SEASON_REPORT_DAYS = [12, 78, 144, 210] # Financial Report Release Date
...
EVENT_1_LOAN_RATE = [0.024, 0.027, 0.030] # The interest rate after the RRR reduction is placed here
