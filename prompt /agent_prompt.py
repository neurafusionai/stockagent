rom procoder.prompt import *

# BACKGROUND_PROMPT = NamedBlock(
#     name="Background",
#     content="""
# You are a stock trader, and you will now simulate interactions with other traders in the market. There are two stocks in the market, A and B, where B is a newly listed stock.

# Next, please complete your trading actions according to the instructions.
#     """
# )
...
#     content="""
# After yesterday's trading close, the stock prices of Company A and Company B were {stock_a_price} yuan/share and {stock_b_price} yuan/share, respectively.

# Other posts from traders on the forum are as follows:
...
#     name="Loan Type",
#     content="""
# 0. 1-year term, benchmark interest rate {loan_rate1}

# 1. 2-year term, benchmark interest rate {loan_rate2}

# 2. 3-year term, benchmark interest rate {loan_rate3}
#     """
# )
...
#     name="Instruction",
#     content="""
# It is currently day {date}. Your current personality is {character}. You hold {stock_a} shares of Company A stock and {stock_b} shares of Company B stock.

# You currently have {cash} yuan in cash, and your loan status is {debt}.

# You need to decide whether to continue the loan and the loan amount.

# The available loan types are {loan_type_prompt}. You should select a loan type using the number. The loan amount cannot exceed {max_loan}.

# Return the result in JSON format, for example:

# {{"loan": "yes", "loan_type": 3, "amount": 1000}}

# If you do not need the loan, return:
...
# You should return the result in JSON format, for example:

# {{"loan": "yes", "loan_type": 2, "amount": 1000}}

# If no loan is needed, return:
#     {{"loan" : "no"}}
#     Please answer again."""
# )
...
#     name="Instruction",
#     content="""
# It is currently the {date}th trading session. After the previous session ended, the stock price of Company A was {stock_a_price}, and the stock price of Company B was {stock_b_price}.

# In the current session, the buy and sell orders for stock A are {stock_a_deals}, and the buy and sell orders for stock B are {stock_b_deals}.

# You currently hold {stock_a} shares of Company A, {stock_b} shares of Company B, and {cash} yuan in cash.

# You need to decide whether to buy/sell shares of Company A or Company B, and the quantity and price to buy/sell. You can refer to the current stock price and the overall market to decide the price yourself; it does not need to be the current stock price. The quantity must be an integer.

# Buying and selling as much as possible is encouraged.

# Return the results in JSON format, for example:
#     {{"action_type":"buy"|"sell", "stock":"A"|"B", amount: 100, price : 30}}
#     If neither buying nor selling, then return:
#     {{"action_type" : "no"}}"""
# )
...
#     You should return the results in JSON format, for example:
#     {{"action_type":"buy"|"sell", "stock":"A"|"B", amount: 100, price: 30}}
#      If neither buying nor selling, then return:
#     {{"action_type" : "no"}}
#     Please answer again."""
...
#     content="""
#     Company A: This stock is fantastic!

#     Company B: This stock has high risk and high reward!
# )
...
#     name="Instruction",
#     content="""
#    The current trading day has ended. Please briefly share your trading insights on the forum and post them there. Your post will be publicly visible to all traders. Only include the content required for posting in your response。"""
# )
...
#     name="Instruction",
#     content="""
#     Based on the current trading day's market information and forum updates, please predict whether you will buy or sell stock A and stock B tomorrow, and whether you will choose to take out a loan. Mark "yes" for actions you anticipate taking, and "no" for actions you will not take.
